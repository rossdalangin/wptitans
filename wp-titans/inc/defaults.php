<?php
/**
 * WP Titans Default Settings
 */

function wp_titans_get_defaults() {
    return array(
        'wp_titans_logo_image' => 'https://wordpresstitans.com/wp-content/uploads/2025/12/logogold.png',
        'wp_titans_logo_icon' => 'fa-crown',
        'wp_titans_logo_text' => 'TITANS',
        'wp_titans_footer_desc' => 'Command attention. Build authority. Scale your influence. We help world-class experts dominate their market through high-performance WordPress systems.',
        'wp_titans_primary_color' => '#D4AF37',
        'wp_titans_heading_font' => 'Syne',
        'wp_titans_body_font' => 'Space Grotesk',
        'wp_titans_hero_title' => 'Bridge the Authority Gap and Dominate Your Market.',
        'wp_titans_hero_subtitle' => 'The world\'s best experts are often invisible. We build elite, cinematic authority platforms that command immediate trust and convert strangers into high-ticket clients in exactly 14 days.',
        'wp_titans_hero_bg' => 'https://images.unsplash.com/photo-1497215728101-856f4ea42174?auto=format&fit=crop&w=1920',
        'wp_titans_hero_btn1_text' => 'The Arsenal',
        'wp_titans_hero_btn1_url' => '#services',
        'wp_titans_hero_btn2_text' => 'Initialize Strategy',
        'wp_titans_hero_btn2_url' => '#contact',
        'wp_titans_target_tagline' => 'Who We Work With',
        'wp_titans_target_main_title' => 'Designed for High-Intent Specialists',
        'wp_titans_about_tagline' => 'THE AUTHORITY SYSTEM™',
        'wp_titans_about_title' => 'Weaponizing Expertise into Digital Legacies.',
        'wp_titans_about_content' => 'WordPress Titans was founded on a singular premise: Mastery deserves perception. We strip away the "commodity" design and replace it with cinematic authority branding. Our signature 14-Day Protocol isn’t just about speed—it’s about deploying a battle-tested architecture that positions you as the definitive choice in your field before you even say a word.',
        'wp_titans_about_image' => 'https://wordpresstitans.com/wp-content/uploads/2025/12/Screenshot-2025-12-06-001551.webp',
        'wp_titans_about_btn_text' => 'Read More',
        'wp_titans_about_btn_url' => '#contact',
        'wp_titans_services_tagline' => 'Our Core Services',
        'wp_titans_services_main_title' => 'Engineered for Conversion & Authority',
        'wp_titans_process_tagline' => 'The Authority System™',
        'wp_titans_process_main_title' => 'Our 4-Step Process',
        'wp_titans_testi_tagline' => 'Trusted by Experts',
        'wp_titans_testi_main_title' => 'Client Results',
        'wp_titans_faq_main_title' => 'Common Questions',
        'wp_titans_services_page_tagline' => 'Our Expertise',
        'wp_titans_services_page_title' => 'Done-for-you website solutions built for consultants, coaches, and service providers.',
        'wp_titans_services_page_subtitle' => 'Designed to convert, impress, and elevate your authority.',
        'wp_titans_process_page_tagline' => 'Our Methodology',
        'wp_titans_process_page_title' => 'Our proven 14-day Authority Website System™',
        'wp_titans_process_page_subtitle' => 'A strategic, high-speed methodology to get your authority platform live.',
        'wp_titans_about_page_tagline' => 'About WordPress Titans',
        ...
        'wp_titans_contact_page_tagline' => 'Get in Touch',
        'wp_titans_contact_page_title' => 'Let’s Build Your Authority Website',
        'wp_titans_contact_page_subtitle' => 'Whether you need a new website, a redesign, or want to grow your authority online — let’s talk.',
        'wp_titans_contact_phone' => '+63 918 418 6025',
        'wp_titans_contact_location' => 'Paete, Laguna, Philippines',
        'wp_titans_auth_title' => 'Authority Website System™',
        'wp_titans_auth_subtitle' => 'A complete, conversion-focused website package designed to position you as the trusted expert in your field.',
        'wp_titans_auth_cta_title' => 'Ready to Stop Losing Clients to a Weak Website?',
        'wp_titans_auth_cta_desc' => 'Our Authority Website System™ is the fastest way to upgrade your professional image and start generating leads.',
        'wp_titans_contact_title' => 'Ready to Build Your Authority Website?',
        'wp_titans_contact_desc' => 'Let’s create a website that showcases your expertise and helps attract your ideal clients.',
        'wp_titans_contact_email' => 'hello@wordpresstitans.com',
        'wp_titans_contact_guarantee' => '14-Day Delivery Guaranteed',
        'wp_titans_contact_btn_text' => 'Book a Strategy Call',
        'wp_titans_contact_btn_url' => '#contact',
        'wp_titans_audit_show' => true,
        'wp_titans_audit_title' => 'Expose Your Authority Gap.',
        'wp_titans_audit_desc' => 'We will manually review your current digital presence and provide a 3-point protocol to bridge the gap between your mastery and your market perception.',
        'wp_titans_sticky_header' => true,
        'wp_titans_back_to_top' => true,
        'wp_titans_mobile_cta' => true,
        'wp_titans_portfolio_page_tagline' => 'Our Portfolio',
        'wp_titans_portfolio_page_title' => 'Success stories from the experts we work with.',
        'wp_titans_logos_title' => 'Trusted by innovative teams worldwide',
        'wp_titans_og_image' => '',
...
function wp_titans_get_default( $key ) {
...
function wp_titans_get_mod( $key ) {
    return get_theme_mod( $key, wp_titans_get_default( $key ) );
}
