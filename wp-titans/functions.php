...
function wp_titans_handle_setup() {
    if ( get_theme_mod( 'wp_titans_generate_pages', false ) ) {
        ...
        $pages = array(
            ...
            'The Invisible Expert' => array(
                'template' => 'page-sales-long.php',
                'content' => "Most experts are world-class at what they do, but invisible to the people who need them most. Is your website an online brochure, or a commanding authority platform?\n\n[STORY]\nYou’ve spent decades mastering your craft. You solve the hard problems. You deliver the world-class results. Yet, when a high-ticket prospect lands on your website, they judge you in 5 seconds based on a template that looks like a commodity. \n\nI call this the **Authority Gap**. \n\nIt’s the silent killer of elite businesses. It’s the reason why your less-qualified competitors are winning the deals you deserve. They aren't better than you; they just *look* more authoritative than you. While you’re focusing on mastery, they’re focusing on perception. \n\nAt WordPress Titans, we believe that world-class mastery deserves world-class perception. We don't build 'sites.' We weaponize your expertise into a cinematic digital presence that commands immediate trust.\n\n[OFFER]\nIntroducing the **Authority Website System™**. \nA complete, high-performance transformation delivered in exactly 14 days.\n\n- Cinematic UI/UX: Design that reflects your premium pricing.\n- Command-Based Copywriting: Messaging that qualifies leads and speaks their language.\n- Velocity Engineering: Sub-2 second load times and enterprise-grade security.\n- Lead Intelligence Hub: Custom project planners and ROI calculators built-in.\n\n[CLOSE]\nStop being the best-kept secret in your industry. The market is moving at Titan velocity. Every day you wait is a day your Authority Gap grows wider."
            ),
            'The Revenue Engine' => array(
                'template' => 'page-sales-long.php',
                'content' => "If your website isn't bringing you clients, it's costing you clients. Most experts are leaving \$10k to \$50k on the table every month due to 'Conversion Friction.' Is it time to reclaim your revenue?\n\n[STORY]\nThe traditional agency model is broken. \n\nThey sell you 'designs' and 'features' but ignore the only metric that matters: Business Outcomes. You wait 4 months for a site that looks pretty but converts like a leaky bucket. While the agency is 'perfecting pixels,' your momentum is dying, and your leads are bouncing.\n\nAt WordPress Titans, we've realized that established businesses don't need another designer. They need a **Revenue Engine**. \n\nWe’ve spent 20 years at the intersection of psychology, high-performance systems, and creative engineering. We know that high-intent leads buy certainty, not 'nice colors.' They need to know, instantly, that you are the solution to their most expensive problems. \n\nOur mission is to deploy that certainty at Titan velocity.\n\n[OFFER]\nThe **14-Day Velocity Sprint**. \nThe fastest way to move from 'Invisible' to 'Dominant.'\n\n- ROI-First Architecture: Every section is designed to drive a singular conversion action.\n- Advanced Lead Scoring: Identify 'Titan' leads (high-budget) automatically.\n- Technical SEO Dominance: Capture the keywords that actually drive revenue.\n- 100% Manual Performance Audit: A 30-point protocol before every launch.\n\n[CLOSE]\nVelocity is the ultimate luxury. \nYou can keep waiting for the 'perfect' time, or you can have an elite authority platform generating leads by this time in two weeks. \n\nThe choice is simple: Commodity or Titan?"
            ),
